                    ...
                    <div class="header-top clearfix rh-flex-center-align">
                        ...
                        <div class="rh-flex-right-align top-social">
                            ...
                            <div class="userblockintop"><span class="act-rehub-login-popup" data-type="login">
                                    <i class="rhicon rhi-sign-in"></i><span>Đăng nhập / Đăng ký</span></span>
                                <div class="use_nam">
                                </div>
                            </div>
                                ...
                                <div class="tabledisplay">
                                    ...
                                    <div class="celldisplay rh_woocartmenu_cell text-center"><span
                                            class="inlinestyle rehub-main-btn-bg rehub-main-smooth menu-cart-btn "><a
                                                ...
                                                href="https://shopmc.com.vn/cart/"><span
                    ...
                    <nav class="top_menu">
                        <ul id="menu-danh-muc-san-pham" class="menu">
                            ...
                            <li id="menu-item-9663"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children">
                                <a href="#"><i class="far fa-copyright"></i> Thương hiệu</a>
                                <ul class="sub-menu">
...
-->                        </rs-slide>
                        ...
                        <div
                            class="vc_row wpb_row vc_row-fluid vc_custom_1607449230309 vc_row-has-fill centered-container">
                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
        ...
        <!?php if (!empty($categories)) {
            ...
            echo '<a href="'.get_term_link((int)$categories[0]->term_id, 'product_cat').'" class="woocat">'.$categories[0]->name.'</a>';
                        ...
                        <div
                            class="vc_row wpb_row vc_row-fluid vc_custom_1607449069956 vc_row-has-fill centered-container">
                            <div class="wpb_column vc_column_container vc_col-sm-12 vc_hidden-xs">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                ...
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper">
                                        <div class="woocommerce">
                                            ...
                                            <div
                                                class="rh-flex-eq-height products  re_aj_pag_auto_wrap col_wrap_six grid_woo"
        ...
        <!?php if (!empty($categories)) {
            ...
            echo '<a href="'.get_term_link((int)$categories[0]->term_id, 'product_cat').'" class="woocat">'.$categories[0]->name.'</a>';
                        ...
                        <div
                            class="vc_row wpb_row vc_row-fluid vc_custom_1607449154738 vc_row-has-fill centered-container">
                            <div class="wpb_column vc_column_container vc_col-sm-12 vc_hidden-xs">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper"><h4
                                            style="font-size: 16px;line-height: 18px;text-align: left"
        ...
        <!?php if (!empty($categories)) {
            ...
            echo '<a href="'.get_term_link((int)$categories[0]->term_id, 'product_cat').'" class="woocat">'.$categories[0]->name.'</a>';
                        ...
                        <div
                            class="vc_row wpb_row vc_row-fluid vc_custom_1607449240984 vc_row-has-fill centered-container">
                            <div class="wpb_column vc_column_container vc_col-sm-12 vc_hidden-xs">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper"><h4
                                            style="font-size: 16px;line-height: 18px;text-align: left"
                        ...
                        <div
                            ...
                            <div class="wpb_column vc_column_container vc_col-sm-12 vc_hidden-xs">
                                <div class="vc_column-inner">
                                    <div class="wpb_wrapper"><h4
                                            style="font-size: 16px;line-height: 18px;text-align: left"
                                            class="vc_custom_heading">Mô hình/ Lego Minecraft</h4>
                                        <div class="woocommerce">
